        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4 portfolio-item">
                    <a class="portfolio-link" href="/facultadweb/{{$facultad->idfac}}">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fas fa-eye fa-4x"></i>
                            </div>
                        </div>
                        <img class="img-fluid" src="{{ asset('img/descripcionFacultades/'.$facultad->imagen) }}"
                            alt="{{$facultad->imagen}}" style="width: 800px;height: 300px;padding: 5px 5px 5px 5px">
                    </a>
                    <div class="portfolio-caption" style="height: 180px">
                        <h5>{{$facultad->nombre}}</h5>
                        <p class="text-muted">{{$facultad->abreviatura}}</p>
                    </div>
                </div>
                @endforeach
            </div>
