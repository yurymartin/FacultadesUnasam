    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-3" style="border-radius: 20px;background-color: #fafafa;margin-left: 10px"
                id="panel-imagen">
                <h5 class="blog-list-title"><a href="{{asset('doc/investigaciones/'.$rta->ruta) }}"
                        target="blank">{{$rta->titulo}}</a></h5>
                <a href="{{asset('doc/investigaciones/'.$rta->ruta)}}" target="blank"><img
                        src="{{asset('img/investigaciones/'.$rta->imagen)}}" alt="" style="width: 150px;height: 150px"
                        class="imagen"></a>
                <p class="blog-list-meta small-text">Autor(es): {{$rta->autor}}</p>
                <p class="blog-list-meta small-text">Fecha Publicacion: {{$rta->fechapublicacion}}</p>
