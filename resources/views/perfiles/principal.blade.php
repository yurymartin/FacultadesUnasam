<div class="box box-primary panel-group">
  <div class="box-header with-border" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
    <h3 class="box-title">Gestión de los perfiles</h3>
    <a style="float: right;" type="button" class="btn btn-default" href="{{URL::to('home')}}"><i class="fa fa-reply-all"
        aria-hidden="true"></i>
      Volver</a>
  </div>

  @can('create perfilprofesional escuelas', Model::class)
...
<div class="box box-success" v-if="divNuevo" style="border: 1px solid #00a65a;">
  <div class="box-header with-border" style="border: 1px solid #00a65a;background-color: #00a65a; color: white;">
    <h3 class="box-title" id="tituloAgregar">Nuevo Perfil profesional</h3>
  </div>
    ...
    <table class="table table-hover table-bordered table-dark table-condensed table-striped">
      <tbody>
        <tr>
          ...
          <th style="border:1px solid #ddd;padding: 5px; width: 20%;">Perfil</th>
        ...
        <tr v-for="perfil, key in perfiles">
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;text-align: justify">@{{key+pagination.from}}
          </td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;text-align: justify">@{{ perfil.descripcion }}
          </td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">@{{ perfil.perfil }}</td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">@{{ perfil.nombre }}</td>
          </td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px; vertical-align: middle;">
            <center>
              <span class="label label-success" v-if="perfil.activo=='1'">Activo</span>
              <span class="label label-warning" v-if="perfil.activo=='0'">Inactivo</span>
            </center>
          </td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">
            <center>
              @can('update perfilprofesional escuelas', Model::class)
              ...
              <a href="#" v-if="perfil.activo=='0'" class="btn btn-success btn-sm"
                v-on:click.prevent="altadocente(perfil)" data-placement="top" data-toggle="tooltip"
              ...
              @can('delete perfilprofesional escuelas', Model::class)
              ...
              <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <textarea name="descripcionE" id="descripcionE" cols="80" rows="5"
                        v-model="fillPerfiles.descripcion" placeholder="descripcion" class="form-control"></textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12" style="padding-top: 15px;">
                  <div class="form-group">
                    <label for="cbEscuelas" class="col-sm-2 control-label">Escuela Profesional:*</label>
                    <div class="col-sm-8">
                      <select name="cbEscuelas" id="cbEscuelas" class="form-control" v-model="fillPerfiles.escuela_id">
