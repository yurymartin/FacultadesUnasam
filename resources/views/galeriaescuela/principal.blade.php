<div class="box box-primary panel-group">
  ...
  @can('create galerias escuelas', Model::class)
      ...
      <tbody>
        ...
        <tr v-for="galeriaE, key in galeriaescuelas">
          ...
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px; vertical-align: middle;">
            <center>
              <span class="label label-success" v-if="galeriaE.activo=='1'">Activo</span>
              <span class="label label-warning" v-if="galeriaE.activo=='0'">Inactivo</span>
            </center>
          </td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">
            <center>
              @can('update galerias escuelas', Model::class)
              ...
              @can('delete galerias escuelas', Model::class)
