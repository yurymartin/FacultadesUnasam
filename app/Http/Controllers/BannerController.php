...
class BannerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ->where(function($query) use ($buscar){
            $query->where('tituloBanner', 'like', '%'.$buscar.'%');
            $query->orWhere('descrBanner', 'like', '%'.$buscar.'%');
    ...
    public function store(Request $request)
    {
        ...
        if($segureImg==1){ 
            ...
            $newBanner->tituloBanner=$titulo;
            $newBanner->descrBanner=$descripcion;
    ...
    public function update(Request $request, $id)
    {
        ...
        else
        {
            ...
            $editBanner = Banner::findOrFail($idBanner);
