  ...
  <div class="box-body" style="border: 1px solid #3c8dbc;">
    <div class="form-group form-primary">
      <button type="button" class="btn btn-primary" id="btnCrear" @click.prevent="nuevo()"><i
          class="fa fa-plus-square-o" aria-hidden="true"></i> Nuevo Evento</button>
    </div>
...
<div class="box box-success" v-if="divNuevo" style="border: 1px solid #00a65a;">
  <div class="box-header with-border" style="border: 1px solid #00a65a;background-color: #00a65a; color: white;">
    <h3 class="box-title" id="tituloAgregar">Nuevo Evento</h3>
  </div>
    ...
    <div class="box-body">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          ...
          <div class="col-sm-8" style="padding-top: 10px;">
            <input name="archivo2" type="file" id="archivo2" class="archivo2 form-control" @change="getImage2"
              accept=".pdf, .PDF" />
          </div>
        </div>
      </div>
    ...
    <table class="table table-hover table-bordered table-dark table-condensed table-striped">
      <tbody>
        <tr>
          ...
          <th style="border:1px solid #ddd;padding: 5px; width: 25%;">Evento</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 10%;">Archivo PDF</th>
        ...
        <tr v-for="evento, key in eventos">
          ...
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;text-align: center;vertical-align: middle;">
            <img :src="getImg(evento)" alt="" class="img img-responsive" style="max-height: 15em;">
          </td> 
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;text-align: center;vertical-align: middle;" >
            <a v-bind:href="getPDF(evento)" target="_blank"><img src="<?php echo e(asset('img/instrumentos/pdf.png')); ?>"  alt="" class="img img-responsive" style="max-height: 5em;"></a>
          </td>
          ...
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;vertical-align: middle;">
            <center>
              <a href="#" v-if="evento.activo=='1'" class="btn bg-navy btn-sm" v-on:click.prevent="bajaevento(evento)"
                data-placement="top" data-toggle="tooltip" title="Desactivar evento"><i
                  class="fa fa-arrow-circle-down"></i></a>

              <a href="#" v-if="evento.activo=='0'" class="btn btn-success btn-sm"
                v-on:click.prevent="altaevento(evento)" data-placement="top" data-toggle="tooltip"
                title="Activar evento"><i class="fa fa-check-circle"></i></a>


              <a href="#" class="btn btn-warning btn-sm" v-on:click.prevent="editevento(evento)" data-placement="top"
                data-toggle="tooltip" title="Editar evento"><i class="fa fa-edit"></i></a>
              <a href="#" class="btn btn-danger btn-sm" v-on:click.prevent="borrarevento(evento)" data-placement="top"
                data-toggle="tooltip" title="Borrar evento"><i class="fa fa-trash"></i></a>
            </center>
          </td>
        </tr>
...
<form method="post" v-on:submit.prevent="updateEvento(fillEvento.id)">
              ...
              <div class="box-body">
                ...
                <div class="col-md-12" style="padding-top: 15px;">
                  <div class="form-group">
                    <label for="archivo2" class="col-sm-2 control-label">Archivo :*</label>
                    <div class="col-sm-8" style="padding-top: 10px;">
                      <input name="archivo2" type="file" id="archivo2" class="archivo form-control" @change="getImage2"
                        accept=".pdf, .PDF" />
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12" style="padding-top: 15px;">
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <select class="form-control" id="cbuestadoE" name="cbuestadoE" v-model="fillEvento.estado">
                        <option value="1">Activado</option>
                        <option value="0">Desactivado</option>
                      </select>
                    </div>
...
</form><?php /**PATH D:\Roger\Aplicaciones\webUNASAM2019\resources\views/evento/principal.blade.php ENDPATH**/ ?>