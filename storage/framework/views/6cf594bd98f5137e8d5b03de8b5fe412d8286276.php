<div class="box box-primary panel-group">
  ...
  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create categoriadocente', Model::class)): ?>
      ...
      <tbody>
        ...
        <tr v-for="catdocente, key in catdocentes">
          ...
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">
            <center>
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update categoriadocente', Model::class)): ?>
              ...
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete categoriadocente', Model::class)): ?>
...
</form><?php /**PATH C:\Users\yuri_\OneDrive\Desktop\webFacultades\resources\views/categoriadocentes/principal.blade.php ENDPATH**/ ?>