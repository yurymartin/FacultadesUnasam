...
data:{
   ...
   fillLibros:{'id':'', 'titulo':'','descripcion':'','fechapublicacion':'','imagen':'','ruta':'','autor':'','estado':'','escuela_id':'','tema_id':''},
...
methods: {
    ...
    getBannerFacultad: function (page) {
       ...
       var url = 'libro?page='+page+'&busca='+busca;
   ...
   updateBanner:function (id) {
    ...
    swal.fire({
            ...
            if (result.value) {
                ...
                var url = 'libro/altabaja/'+libro.idlibros+'/0';
   ...
   altabanner:function (libro) {
    swal.fire({
            ...
            if (result.value) {
                ...
                var url = 'libro/altabaja/'+libro.idlibros+'/1';
                       axios.get(url).then(response=>{//eliminamos
                       if(response.data.result=='1'){
                           app.getBannerFacultad(app.thispage);//listamos
                           toastr.success(response.data.msj);//mostramos mensaje
...
</script><?php /**PATH C:\Users\yuri_\OneDrive\Desktop\webFacultades\resources\views/libros/vue.blade.php ENDPATH**/ ?>