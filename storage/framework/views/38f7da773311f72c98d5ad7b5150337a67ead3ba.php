...
<div class="box box-success" v-if="divNuevo" style="border: 1px solid #00a65a;">
  ...
  <form v-on:submit.prevent="create">
    <div class="box-body">
        ...
        <div class="form-group" style="padding-top: 15px;">
          ...
          <div class="col-sm-8">
            <textarea name="historia" id="historia" cols="80" rows="5" v-model="newHistoria"
              placeholder="historia" class="form-control"></textarea>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="form-group" style="padding-top: 15px;">
          <label for="filosofia" class="col-sm-2 control-label">Filosofia:*</label>
          <div class="col-sm-8">
            <textarea name="filosofia" id="filosofia" cols="80" rows="5" v-model="newFilosofia"
              placeholder="filosofia" class="form-control"></textarea>
          </div>
        </div>
      </div>
...
<div class="box box-primary" style="border: 1px solid #3c8dbc;">
  <div class="box-header" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
    <h3 class="box-title">Listado de Descripcion de las escuelas</h3>
    ...
    <table class="table table-hover table-bordered table-dark table-condensed table-striped">
      <tbody>
        <tr>
          ...
          <th style="border:1px solid #ddd;padding: 5px; width: 14%;">Descripciòn</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 14%;">Misio</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 14%;">Vision</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 14%;">Historia</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 14%;">Filosofia</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 14%;">Escuela Profesional</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 5%;">Estado</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 10%;">Gestión</th>
        </tr>
        <tr v-for="nosotrosescuela, key in nosotrosescuelas">
          ...
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;text-align: justify">
            {{ nosotrosescuela.descripcion }}</td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;text-align: justify">{{ nosotrosescuela.mision }}</td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;text-align: justify">{{ nosotrosescuela.vision }}</td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;text-align: justify">{{ nosotrosescuela.historia }}</td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;text-align: justify">{{ nosotrosescuela.filosofia }}</td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">{{ nosotrosescuela.nombre }}</td> 
          </td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px; vertical-align: middle;">
            <center>
              <span class="label label-success" v-if="nosotrosescuela.activo=='1'">Activo</span>
              <span class="label label-warning" v-if="nosotrosescuela.activo=='0'">Inactivo</span>
            </center>
          </td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">
            <center>
              <a href="#" v-if="nosotrosescuela.activo=='1'" class="btn bg-navy btn-sm"
                v-on:click.prevent="bajadocente(nosotrosescuela)" data-placement="top" data-toggle="tooltip"
                title="Desactivar nosotros escuela "><i class="fa fa-arrow-circle-down"></i></a>

              <a href="#" v-if="nosotrosescuela.activo=='0'" class="btn btn-success btn-sm"
                v-on:click.prevent="altadocente(nosotrosescuela)" data-placement="top" data-toggle="tooltip"
                title="Activar descripcion escuela"><i class="fa fa-check-circle"></i></a>

              <a href="#" class="btn btn-warning btn-sm" v-on:click.prevent="editbanner(nosotrosescuela)"
                data-placement="top" data-toggle="tooltip" title="Editar descripcion facultad"><i
                  class="fa fa-edit"></i></a>

              <a href="#" class="btn btn-danger btn-sm" v-on:click.prevent="borrardocente(nosotrosescuela)"
...
<form method="post" v-on:submit.prevent="updateBanner(fillNosotrosEscuelas.id)">
              ...
              <div class="box-body">
                ...
                <div class="col-md-12">
                  <div class="form-group" style="padding-top: 15px;">
                    <label for="descripcion" class="col-sm-2 control-label">Descripcion:*</label>
                    <div class="col-sm-8">
                      <textarea name="descripcion" id="descripcion" cols="80" rows="5" v-model="fillNosotrosEscuelas.descripcion"
                        placeholder="descripcion" class="form-control"></textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group" style="padding-top: 15px;">
                    <label for="mision" class="col-sm-2 control-label">Mision:*</label>
                    <div class="col-sm-8">
                      <textarea name="mision" id="mision" cols="80" rows="5" v-model="fillNosotrosEscuelas.mision"
                        placeholder="mision" class="form-control"></textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group" style="padding-top: 15px;">
                    <label for="vision" class="col-sm-2 control-label">Vision:*</label>
                    <div class="col-sm-8">
                      <textarea name="vision" id="vision" cols="80" rows="5" v-model="fillNosotrosEscuelas.vision"
                        placeholder="vision" class="form-control"></textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group" style="padding-top: 15px;">
                    <label for="historia" class="col-sm-2 control-label">Historia:*</label>
                    <div class="col-sm-8">
                      <textarea name="historia" id="historia" cols="80" rows="5" v-model="fillNosotrosEscuelas.historia"
                        placeholder="historia" class="form-control"></textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group" style="padding-top: 15px;">
                    <label for="filosofia" class="col-sm-2 control-label">Filosofia:*</label>
                    <div class="col-sm-8">
                      <textarea name="filosofia" id="filosofia" cols="80" rows="5" v-model="fillNosotrosEscuelas.filosofia"
                        placeholder="filosofia" class="form-control"></textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12" style="padding-top: 15px;">
                  <div class="form-group">
                    <label for="cbEscuelas" class="col-sm-2 control-label">Escuela Profesional:*</label>
                    <div class="col-sm-8">
                      <select name="cbEscuelas" id="cbEscuelas" class="form-control" v-model="fillNosotrosEscuelas.escuela_id">
                        <option disabled value="0">Seleccione una Escuela Profesional</option>
                        <option v-for="escuela, key in escuelas" v-bind:value="escuela.id">{{escuela.nombre}}
                        </option>
                      </select>
...
</form><?php /**PATH C:\Users\yuri_\OneDrive\Desktop\webFacultades\resources\views/NosotrosEscuelas/principal.blade.php ENDPATH**/ ?>