<div class="box box-primary panel-group">
  <div class="box-header with-border" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
    <h3 class="box-title">Gestión de los tipos de publicaciones</h3>
    <a style="float: right;" type="button" class="btn btn-default" href="<?php echo e(URL::to('home')); ?>"><i class="fa fa-reply-all"
        aria-hidden="true"></i>
      Volver</a>
  </div>

  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create tipo publicacion', Model::class)): ?>
  <div class="box-body" style="border: 1px solid #3c8dbc;">
    <div class="form-group form-primary">
      <button type="button" class="btn btn-primary" id="btnCrear" @click.prevent="nuevo()"><i
          class="fa fa-plus-square-o" aria-hidden="true"></i>Nuevo Tipo de publicacion</button>
    </div>
...
<div class="box box-success" v-if="divNuevo" style="border: 1px solid #00a65a;">
  <div class="box-header with-border" style="border: 1px solid #00a65a;background-color: #00a65a; color: white;">
    <h3 class="box-title" id="tituloAgregar">Nuevo Tipo de publicacion</h3>
  </div>
    ...
    <div class="box-body">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <label for="tipo" class="col-sm-2 control-label">Tipo Publicacion*</label>
          <div class="col-sm-8">
            <input type="text" class="form-control" id="tipo" name="tipo" placeholder="tipo de publicacion" maxlength="200"
              autofocus v-model="tipo">
          </div>
        </div>
      </div>
    ...
    <table class="table table-hover table-bordered table-dark table-condensed table-striped">
      <tbody>
        <tr>
          ...
          <th style="border:1px solid #ddd;padding: 5px; width: 20%;">Tipo</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 5%;">Estado</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 10%;">Gestión</th>
        </tr>
        <tr v-for="tipopublicacion, key in tipopublicaciones">
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px">{{key+pagination.from}}</td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px">{{ tipopublicacion.tipo }}</td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px; vertical-align: middle;">
            <center>
              <span class="label label-success" v-if="tipopublicacion.activo=='1'">Activo</span>
              <span class="label label-warning" v-if="tipopublicacion.activo=='0'">Inactivo</span>
            </center>
          </td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">
            <center>
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update tipo publicacion', Model::class)): ?>
              <a href="#" v-if="tipopublicacion.activo=='1'" class="btn bg-navy btn-sm" v-on:click.prevent="bajadocente(tipopublicacion)"
                data-placement="top" data-toggle="tooltip" title="Desactivar descripcion escuela"><i
                  class="fa fa-arrow-circle-down"></i></a>

              <a href="#" v-if="tipopublicacion.activo=='0'" class="btn btn-success btn-sm" v-on:click.prevent="altadocente(tipopublicacion)"
                data-placement="top" data-toggle="tooltip" title="Activar descripcion escuela"><i
                  class="fa fa-check-circle"></i></a>

              <a href="#" class="btn btn-warning btn-sm" v-on:click.prevent="editbanner(tipopublicacion)" data-placement="top"
                data-toggle="tooltip" title="Editar descripcion facultad"><i class="fa fa-edit"></i></a>
              <?php endif; ?>

              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete tipo publicacion', Model::class)): ?>
              <a href="#" class="btn btn-danger btn-sm" v-on:click.prevent="borrardocente(tipopublicacion)" data-placement="top"
            ...
            <div class="box" id="o" style="border:0px; box-shadow:none;">
              ...
              <div class="box-body">
                ...
                <div class="col-md-12" style="padding-top: 10px;">
                  <div class="form-group">
                    <label for="tipo" class="col-sm-2 control-label">Tema de Estudio:*</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="tipo" name="tipo" placeholder="tipo de publicacion"
                        maxlength="200" autofocus v-model="fillTema.tipo">
                    </div>
                  </div>
                </div>
...
</form><?php /**PATH C:\Users\yuri_\OneDrive\Desktop\webFacultades\resources\views/tipopublicaciones/principal.blade.php ENDPATH**/ ?>