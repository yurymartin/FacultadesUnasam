<div class="box box-primary panel-group">
  ...
  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create departamentoacademico', Model::class)): ?>
      ...
      <tbody>
        ...
        <tr v-for="departamento, key in departamentos">
          ...
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">
            <center>
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update departamentoacademico', Model::class)): ?>
              ...
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete departamentoacademico', Model::class)): ?>
...
</form><?php /**PATH C:\Users\yuri_\OneDrive\Desktop\webFacultades\resources\views/departamentoacademicos/principal.blade.php ENDPATH**/ ?>