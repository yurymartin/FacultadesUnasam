...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li v-bind:class="classMenu0"><a href="<?php echo e(url('facultades')); ?>"><i class='fa fa-home'></i> <span>Facultades</span></a>
            <?php endif; ?>
            <?php if(accesoUser([1,2,3])): ?>
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH C:\Users\Yuri Martin\Desktop\webFacultades\resources\views/vendor/adminlte/layouts/partials/sidebar.blade.php ENDPATH**/ ?>