   ...
   getImage(event){
    ...
    recorrerBanner:function () { 
            $.each($(".txtimg"), function( index, value ) {
             ...
             $("#ImgPerfilNuevoE"+idusar).attr("src","<?php echo e(asset('/img/bannersFacultad/')); ?>"+"/"+$("#txt"+idusar).val());
         });
    },
    create:function () { 
...
</script><?php /**PATH C:\Users\yuri_\OneDrive\Desktop\webFacultades\resources\views/banners/vue.blade.php ENDPATH**/ ?>