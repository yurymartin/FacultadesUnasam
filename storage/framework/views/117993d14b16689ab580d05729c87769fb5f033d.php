...
methods: {
    getfile(investigaciones){
        var ruta_pdf = "<?php echo e(asset('/')); ?>doc/investigaciones/"+ investigaciones.ruta;
        window.open(ruta_pdf);
    },
    getImg(investigaciones){
        var img = "<?php echo e(asset('/')); ?>img/investigaciones/"+ investigaciones.imagen;
        return img;
    },
...
</script><?php /**PATH C:\Users\yuri_\OneDrive\Desktop\webFacultades\resources\views/investigaciones/vue.blade.php ENDPATH**/ ?>