...
<script src="<?php echo e(asset('js/sweetalert2.all.js')); ?>"  type="text/javascript"></script>
<script src="<?php echo e(asset('js/select2.js')); ?>"  type="text/javascript"></script>
...
<script src="<?php echo e(asset('js/component.js')); ?>"  type="text/javascript"></script>
<script src="<?php echo e(asset('js/bootstrap-colorpicker.js')); ?>"  type="text/javascript"></script>
<script src="<?php echo e(asset('js/toastr.js')); ?>"  type="text/javascript"></script>
...
<?php /**PATH C:\Users\yuri_\OneDrive\Desktop\webFacultades\resources\views/vendor/adminlte/layouts/partials/scripts.blade.php ENDPATH**/ ?>