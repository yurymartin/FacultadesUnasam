...
methods: {
    getImg(galeriaE){
        var img = "<?php echo e(asset('/')); ?>img/galeriaEscuelas/"+ galeriaE.imagen;
        return img;
    },
   getBanner: function (page) {
       var busca=this.buscar;
       var url = 'galeriaescuela?page='+page+'&busca='+busca;
   ...
   borrarbanner:function (galeriaE) {
        ...
        swal.fire({
            ...
            if (result.value) {
                ...
                var url = 'galeriaescuela/'+galeriaE.id;
   ...
   editGalEscu:function (galeriaE) {

        this.fillGalEcuela.id=galeriaE.id;
        this.fillGalEcuela.imagen=galeriaE.imagen;
   ...
   updateGalEscuela:function (id) {
       ...
       var newEscuela = $("#cbescuela").val();
        ...
        axios.post(url, data, config).then(response => {
           ...
           if(response.data.result=='1'){   
           this.getBanner(this.thispage);
           this.fillLocal={'id':'', 'imagen':'', 'descripcion':'','estado':''};
           this.errors=[];
    ...
    swal.fire({
            ...
            if (result.value) {
                ...
                var url = 'galeriaescuela/altabaja/'+galeriaE.id+'/0';
   ...
   altabanner:function (galeriaE) {
    swal.fire({
            ...
            if (result.value) {
                ...
                var url = 'galeriaescuela/altabaja/'+galeriaE.id+'/1';
                       axios.get(url).then(response=>{//eliminamos
                       if(response.data.result=='1'){
                           app.getBanner(app.thispage);//listamos
                           toastr.success(response.data.msj);//mostramos mensaje
...
</script><?php /**PATH C:\Users\yuri_\OneDrive\Desktop\webFacultades\resources\views/galeriaescuela/vue.blade.php ENDPATH**/ ?>