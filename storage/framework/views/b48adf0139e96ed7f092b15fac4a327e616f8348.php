<div class="box box-primary panel-group">
  <div class="box-header with-border" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
    <h3 class="box-title">Gestión de Redes Sociales de la Facultad</h3>
    <a style="float: right;" type="button" class="btn btn-default" href="<?php echo e(URL::to('home')); ?>"><i class="fa fa-reply-all"
        aria-hidden="true"></i>
      Volver</a>
  </div>
  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create redes sociales facultad', Model::class)): ?>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('read redes sociales facultad')): ?>
<div class="box box-primary" style="border: 1px solid #3c8dbc;">
  <div class="box-header" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
    <h3 class="box-title">Listado de Redes Sociales de la Facultad</h3>
    ...
    <table class="table table-hover table-bordered table-dark table-condensed table-striped"
      ...
      <tbody>
        <tr>
          ...
          <th style="border:1px solid #ddd;padding: 5px; width: 8%;">Facebook</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 8%;">Google</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 8%;">Youtube</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 8%;">Twitter</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 8%;">Instagram</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 8%;">Linkedln</th>
          <th style="border:1px solid #ddd;padding: 5px; width: 8%;">Pinterest</th>
        ...
        <tr v-for="redes, key in redesfacultades" style="text-align: center">
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">{{key+pagination.from}}</td>

          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;"><a href=""
          ...
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;"><a href="#"
              ...
              v-if="redes.pinterest != 'null'"><i class="fa fa-pinterest-square"></i></a>
          </td>
          ...
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">
            <center>
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update redes sociales facultad')): ?>
              ...
              <?php endif; ?>
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete redes sociales facultad')): ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <select name="facultad_id" id="facultad_id" class="form-control"
                        v-model="fillredesfacultades.facultad_id">
                        <option value="0">Seleccione una facultad</option>
                        <option v-for="facultad, key in facultades" v-bind:value="facultad.id">
                          {{facultad.nombre}} - {{facultad.abreviatura}}
                        </option>
...
</form><?php /**PATH C:\Users\yuri_\OneDrive\Desktop\webFacultades\resources\views/redesfacultades/principal.blade.php ENDPATH**/ ?>