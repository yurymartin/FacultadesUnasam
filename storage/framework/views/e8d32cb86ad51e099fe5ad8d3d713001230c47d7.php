<div class="box box-primary panel-group">
  ...
  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create mallas escuelas', Model::class)): ?>
    ...
    <div class="box-body">
      ...
      <div class="col-md-12">
        <div class="form-group" style="padding-top: 15px;">
          <label for="txtcurricula" class="col-sm-2 control-label">N° Curricula:*</label>
          <div class="col-sm-8">
            <input type="text" class="form-control" id="txtcurricula" name="txtcurricula" placeholder="Curricula"
              maxlength="500" v-model="newCurricula">
          </div>
        </div>
      </div>
    ...
    <table class="table table-hover table-bordered table-dark table-condensed table-striped">
      <tbody>
        ...
        <tr v-for="mallaE, key in mallaescuelas">
          ...
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">{{mallaE.nombre }}</td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px; vertical-align: middle;">
            <center>
              <span class="label label-success" v-if="mallaE.activo=='1'">Activo</span>
              <span class="label label-warning" v-if="mallaE.activo=='0'">Inactivo</span>
            </center>
          </td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">
            <center>
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update mallas escuelas', Model::class)): ?>
              ...
              <a href="#" v-if="mallaE.activo=='0'" class="btn btn-success btn-sm"
                v-on:click.prevent="altabanner(mallaE)" data-placement="top" data-toggle="tooltip"
              ...
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete mallas escuelas', Model::class)): ?>
          ...
          <div class="row">
            <div class="box" id="o" style="border:0px; box-shadow:none;">
              ...
              <div class="box-body">
                ...
                <div class="col-md-12">
                  <div class="form-group" style="padding-top: 15px;">
                    <label for="txtdescripcionE" class="col-sm-2 control-label">N° Curricula:*</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="txtdescripcionE" name="txtdescripcionE"
                        placeholder="Curricula" maxlength="500" v-model="fillGalEcuela.numcurricula">
                    </div>
                  </div>
                </div>
...
</form><?php /**PATH C:\Users\yuri_\OneDrive\Desktop\webFacultades\resources\views/mallaescuela/principal.blade.php ENDPATH**/ ?>