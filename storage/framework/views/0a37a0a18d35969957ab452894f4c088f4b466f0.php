                ...
                <ul class="main-menu sf-menu">
                    ...
                    <li><a href="#">Carreras Profesionales</a>
                        <ul class="sub-menu">
                            ...
                            <li><a href="/escuelaweb/<?php echo e($escuela->id); ?>" name='idescuela'><?php echo e($escuela->nombre); ?></a></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </li>
...
</header> <!-- /.site-header --><?php /**PATH C:\Users\yuri_\OneDrive\Desktop\webFacultades\resources\views/web/layout/header.blade.php ENDPATH**/ ?>