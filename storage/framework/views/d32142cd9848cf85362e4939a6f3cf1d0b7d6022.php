<div class="box box-primary panel-group">
  ...
  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create escuelas', Model::class)): ?>
...
<div class="box box-success" v-if="divNuevo" style="border: 1px solid #00a65a;">
  <div class="box-header with-border" style="border: 1px solid #00a65a;background-color: #00a65a; color: white;">
    <h3 class="box-title" id="tituloAgregar">Nuevo Escuela</h3>
  </div>
        ...
        <tr v-for="escuela, key in escuelas">
          ...
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px; vertical-align: middle;">
            <center>
              ...
              <span class="label label-warning" v-if="escuela.activo=='0'">Inactivo</span>
            </center>
          </td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">
            <center>
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update escuelas', Model::class)): ?>
              ...
              <a href="#" v-if="escuela.activo=='0'" class="btn btn-success btn-sm"
              ...
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete escuelas', Model::class)): ?>
...
</form><?php /**PATH C:\Users\yuri_\OneDrive\Desktop\webFacultades\resources\views/escuelas/principal.blade.php ENDPATH**/ ?>