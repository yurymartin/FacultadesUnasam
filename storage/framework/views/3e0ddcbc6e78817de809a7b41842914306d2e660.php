<div class="box box-primary panel-group">
  ...
  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create banners facultad', Model::class)): ?>
  ...
  <div class="box-body table-responsive">
    <table class="table table-hover table-bordered table-dark table-condensed table-striped">
      <tbody>
        ...
        <tr v-for="bannersFacultad, key in bannersFacultades">
          ...
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px; vertical-align: middle;">
            <center>
              ...
              <span class="label label-warning" v-if="bannersFacultad.activo=='0'">Inactivo</span>
            </center>
          </td>
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">
            <center>
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update banners facultad', Model::class)): ?>
              ...
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete banners facultad', Model::class)): ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="txttituloE" name="txttituloE" placeholder="Banner"
                        maxlength="200" autofocus v-model="fillBannerFacultad.titulo">
                    </div>
                  </div>
                </div>
                  ...
                  <div class="form-group" style="padding-top: 15px;">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="txtdescripcionE" name="txtdescripcionE"
                        placeholder="Descripcion" maxlength="500" v-model="fillBannerFacultad.descripcion">
                    </div>
                  </div>
                </div>
...
</form><?php /**PATH C:\Users\yuri_\OneDrive\Desktop\webFacultades\resources\views/bannersFacultad/principal.blade.php ENDPATH**/ ?>