<script type="text/javascript">
    ...
    subtitulo: "Gestión de los Permisos a los Roles",
...
methods: {
    getDescripcionFacultades: function (page) { 
        ...
        var url='rolespermiso?page=' + page + '&busca=' + busca; 
        axios.get(url).then(response=> {
            this.roles_has_permisos = response.data.roles_has_permisos.data;
    ...
    editbanner: function (temas) {
        this.fillrolpermiso.id = temas.id;
        this.fillrolpermiso.tema = temas.tema;
    ...
    updateBanner: function (id) {
        ...
        var data = new FormData();
        data.append('id', this.fillrolpermiso.id);
        data.append('tema', this.fillrolpermiso.tema);
...
</script><?php /**PATH C:\Users\yuri_\OneDrive\Desktop\webFacultades\resources\views/rolesypermisos/vue.blade.php ENDPATH**/ ?>