...
data:{
       ...
       subtitulo: "Gestión de Videos de Facebook",
...
methods: {
   getVideo: function (page) {
       ...
       var url = 'videofb?page='+page+'&busca='+busca;
   ...
   updateVideo:function (id) {
    ...
    swal.fire({
            ...
            if (result.value) {
                ...
                var url = 'videofb/altabaja/'+video.id+'/0';
   ...
   altaVideo:function (video) {
    ...
    swal.fire({
            ...
            if (result.value) {
                ...
                var url = 'videofb/altabaja/'+video.id+'/1';
                       axios.get(url).then(response=>{//eliminamos
...
</script><?php /**PATH D:\Roger\Aplicaciones\webUNASAM2019\resources\views/videofb/vue.blade.php ENDPATH**/ ?>