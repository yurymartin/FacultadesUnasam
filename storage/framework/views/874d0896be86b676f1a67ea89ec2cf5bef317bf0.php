<div class="box box-primary panel-group">
  ...
  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create banners escuelas', Model::class)): ?>
      ...
      <tbody>
        ...
        <tr v-for="banner, key in bannersescuelas">
          ...
          <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">
            <center>
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update banners escuelas', Model::class)): ?>
              ...
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete banners escuelas', Model::class)): ?>
...
</form><?php /**PATH C:\Users\yuri_\OneDrive\Desktop\webFacultades\resources\views/bannerescuela/principal.blade.php ENDPATH**/ ?>